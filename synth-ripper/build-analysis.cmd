...
FOR %%A in (target\synth-ripper*.jar) do (set "JAR_PATH=%%A")
...
%JAVA_HOME%\bin\java -agentlib:native-image-agent=config-merge-dir=%GRAAL_ANALYSIS_FOLDER% -jar %JAR_PATH% rip -c "./config/config-analysis.yml"
