package com.hypercube.workshop.midiworkshop.common.sysex.manufacturer;
...
import com.hypercube.workshop.midiworkshop.common.sysex.manufacturer.behringer.BehringerDevice;
import com.hypercube.workshop.midiworkshop.common.sysex.manufacturer.behringer.BehringerSysExParser;
import com.hypercube.workshop.midiworkshop.common.sysex.manufacturer.roland.RolandDevice;
import com.hypercube.workshop.midiworkshop.common.sysex.manufacturer.roland.RolandSysExParser;
...
import static com.hypercube.workshop.midiworkshop.common.sysex.util.SysExConstants.ROLAND_SOUND_CANVAS_DEVICE_MULTI;
import static com.hypercube.workshop.midiworkshop.common.sysex.util.SysExConstants.ROLAND_SOUND_CANVAS_DEVICE_SINGLE;
...
public enum Manufacturer {
    ...
    private <T extends Device> Manufacturer(String title, int code, ManufacturerSysExParser parser, Class<T> deviceClass, List<DeviceDefinition> devices) {
        this.title = title;
        this.code = code;
        ...
        this.parser = Optional.ofNullable(parser)
                .orElseGet(ManufacturerSysExParser::new);
    }
    ...
    private Manufacturer(String title, int code) {
        ...
        this.code = code;
        this.devices = null;
        this.parser = new ManufacturerSysExParser();
    }

    private final String title;
    private final int code;
    private final Devices<? extends Device> devices;
    private final ManufacturerSysExParser parser;
